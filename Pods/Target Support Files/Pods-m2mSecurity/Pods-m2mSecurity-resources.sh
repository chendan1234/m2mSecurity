...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYAvatarEditKit/TYCropViewControllerBundle.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYHybridContainer/TYHybridContainer.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYNavigationController/TYNavigationRes.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYSmartActionDialog/TYSmartActionDialog.bundle"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.23.5.4-tybizbundle/Assets/resources/cell_view_arrow@2x.png"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.23.5.4-tybizbundle/Assets/resources/cell_view_arrow@3x.png"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYUIKit/TYUIKitLibraryRes.bundle"
  install_resource "${PODS_ROOT}/TYUrlPredefined/TYUrlPredefined-0.2.102/Assets/resources/ty_route_config.json"
  ...
  install_resource "${PODS_ROOT}/TuyaSmartBizCore/TuyaSmartBizCore-3.27.5.2/Assets/resources/custom.json"
