...
install_xcframework "${PODS_ROOT}/TuyaSecurityBaseKit/Build/TuyaSecurityBaseKit.xcframework" "TuyaSecurityBaseKit" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
