...
install_xcframework "${PODS_ROOT}/TuyaSmartBLEKit/Build/TuyaSmartBLEKit.xcframework" "TuyaSmartBLEKit" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
