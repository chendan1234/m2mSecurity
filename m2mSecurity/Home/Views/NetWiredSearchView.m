...
@implementation NetWiredSearchView

+(instancetype)reload
{
    return [[[NSBundle mainBundle]loadNibNamed:@"NetWiredSearchView" owner:nil options:nil]lastObject];
}
